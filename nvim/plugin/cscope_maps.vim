...
if has("cscope")
	...
	" Open in new tab"
    nmap <leader>ts :tabe scs find s <C-R>=expand("<cword>")<CR><CR>
    nmap <leader>tg :tabe scs find g <C-R>=expand("<cword>")<CR><CR>
    nmap <leader>tc :tabe scs find c <C-R>=expand("<cword>")<CR><CR>
    nmap <leader>tt :tabe scs find t <C-R>=expand("<cword>")<CR><CR>
    nmap <leader>te :tabe scs find e <C-R>=expand("<cword>")<CR><CR>
    nmap <leader>tf :tabe scs find f <C-R>=expand("<cfile>")<CR><CR>	
    nmap <leader>ti :tabe scs find i ^<C-R>=expand("<cfile>")<CR>$<CR>	
    nmap <leader>td :tabe scs find d <C-R>=expand("<cword>")<CR><CR>
